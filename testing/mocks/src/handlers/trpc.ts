 ...
 * tRPC用のモックハンドラー
 *
 * apps/apiのtRPCエンドポイントをモックします。
 * tRPCはhttpBatchLinkを使用してバッチリクエストを送信するため、
 * POSTリクエストでバッチ形式のデータを受け取ります。
 */
...
/**
 * tRPCバッチリクエストを処理するハンドラー
 * httpBatchLinkは複数のリクエストを1つのPOSTリクエストにバッチ化します
 */
