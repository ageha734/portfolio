/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 19cfe2003cec1d8b4ede94ff0863db61)
...
declare namespace Cloudflare {
	interface Env {
		...
		VITE_GOOGLE_TAG_MANAGER_ENABLED: string;
		VITE_GRAPHCMS_ADMIN: string;
		VITE_GRAPHCMS_TOKEN: string;
		VITE_GRAPHCMS_URL: string;
		VITE_XSTATE_INSPECTOR_ENABLED: string;
		VITE_SENTRY_DSN: string;
		VITE_SENTRY_ENVIRONMENT: string;
		VITE_SENTRY_TRACES_SAMPLE_RATE: string;
		VITE_SENTRY_REPLAY_SAMPLE_RATE: string;
		VITE_SENTRY_REPLAY_ON_ERROR_SAMPLE_RATE: string;
	}
}
