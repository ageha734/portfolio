...
export declare const getPortfolios: () => {
    ...
    portfoliosUploadPortfolioImage: (portfolioId: string, portfoliosUploadPortfolioImageBody: Blob, options?: SecondParameter<typeof customInstance<Asset>>) => Promise<Asset>;
};
