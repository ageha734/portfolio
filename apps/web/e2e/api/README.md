...
```bash
# すべてのAPIテストを実行
bun run e2e -- apps/web/e2e/api

# 特定のテストファイルを実行
bun run e2e -- apps/web/e2e/api/blog.spec.ts
bun run e2e -- apps/web/e2e/api/portfolio.spec.ts
bun run e2e -- apps/web/e2e/api/seo.spec.ts
bun run e2e -- apps/web/e2e/api/headers.spec.ts
```
