export const SectionHardware = () => {
    ...
    return (
        <section className="m-auto max-w-6xl px-4 py-20 md:my-10">
            ...
            <p>
                I've been happily developing on a Mac over the last 10+ years. However, I grew up on PC's and built a
                few rigs over the years for gaming and work. Now days a perk of working in Software our employer often
                supplies a well equipped box.
            </p>
