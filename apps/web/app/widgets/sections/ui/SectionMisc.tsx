        ...
        <section className="m-auto max-w-6xl px-4 md:my-20">
            <div className="flex flex-col gap-10 md:flex-row">
                <div>
                    ...
                    <p>
                        Living in San Diego you can find me and the family at the beach! Otherwise there's a good chance
                        I am hauling ass along the coast on my motorcycle 🏍️💨.
                    </p>
                </div>
                <div className="flex shrink-0 flex-wrap gap-4">
                    <img
                        alt="Me, my son, and our dog at the beach"
                        className="aspect-square max-w-[47%] grow"
                        height="auto"
                        loading="lazy"
