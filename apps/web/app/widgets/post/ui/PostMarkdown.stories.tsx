...
export const Paragraph = () => (
	<MemoryRouter>
		<P>
			This is a paragraph with some text content. It demonstrates the paragraph
			styling used in blog posts.
		</P>
	</MemoryRouter>
);
...
export const Blockquote = () => (
	<MemoryRouter>
		<BlockquoteComponent>
			This is a blockquote. It can contain multiple paragraphs and other
			content.
		</BlockquoteComponent>
	</MemoryRouter>
);
...
export const FullExample = () => (
	<MemoryRouter>
		<div className="mx-auto max-w-3xl p-4">
			...
			<P>
				This paragraph contains a <A href="/blog">link</A> and some{" "}
