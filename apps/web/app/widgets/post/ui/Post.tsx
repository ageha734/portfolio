...
export const Post = ({
	...
	const placeholder = banner
		? `${banner.split(".")[0]}-placeholder.jpg`
		: undefined;
	...
	return (
		<article className="relative grid overflow-x-hidden">
			<section>
				{banner && placeholder && (
					<div
						className="absolute inset-x-0 top-0 isolate h-[70vh] overflow-hidden"
						ref={imageRef}
					>
				...
				<header className="relative grid grid-cols-[1fr_60px_680px_60px_1fr] items-center gap-4 md:grid-cols-[1fr_100px_740px_100px_1fr] lg:grid-cols-[1fr_100px_740px_100px_1fr]">
					<div className="relative col-start-3 flex h-full w-full max-w-[800px] flex-col justify-center gap-8 pt-20 md:col-start-3 md:pt-24">
						<div
							className="relative grid grid-cols-[100px_1fr] items-center gap-4 md:gap-4"
							ref={nodeRef}
						>
							<div
						...
						<h1
							className="font-extrabold font-serif text-4xl leading-tight md:text-6xl"
							aria-label={title}
						>
