	...
	<ProjectContainer>
		<ProjectSection>
			<ProjectSectionContent>
				...
				<ProjectSectionText>
					This is the section text content. It describes the details of this
					particular section.
				</ProjectSectionText>
			</ProjectSectionContent>
		</ProjectSection>
		...
		<ProjectSection>
			<ProjectSectionContent>
				<ProjectTextRow>
					...
					<ProjectSectionText>
						Creating a portfolio that effectively showcases work while
		...
		<ProjectSection light padding="both">
			<ProjectSectionContent>
				<ProjectTextRow center>
					...
					<ProjectSectionText>
						Built with modern technologies like React, Remix, and Tailwind CSS
