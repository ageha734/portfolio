...
export const WithClassName = () => <Tags className="rounded-lg bg-gray-100 p-4 dark:bg-gray-800" tags={sampleTags} />;

export const WithTagClassName = () => (
    <Tags tags={sampleTags} classNameTag="px-3 py-1 bg-blue-500 text-white rounded-full text-sm" />
);
