...
export const GOOGLE_ANALYTICS =
	import.meta.env.VITE_GOOGLE_ANALYTICS ?? "__undefined__";
export const GOOGLE_TAG_MANAGER =
	import.meta.env.VITE_GOOGLE_TAG_MANAGER ?? "__undefined__";
export const GOOGLE_ANALYTICS_ENABLED =
	import.meta.env.VITE_GOOGLE_ANALYTICS_ENABLED === "true";
export const GOOGLE_TAG_MANAGER_ENABLED =
	import.meta.env.VITE_GOOGLE_TAG_MANAGER_ENABLED === "true";

export const XSTATE_INSPECTOR_ENABLED =
...
export const SENTRY_TRACES_SAMPLE_RATE = import.meta.env
	...
	: 1;
export const SENTRY_REPLAY_SAMPLE_RATE = import.meta.env
	.VITE_SENTRY_REPLAY_SAMPLE_RATE
	? Number.parseFloat(import.meta.env.VITE_SENTRY_REPLAY_SAMPLE_RATE)
	: 0.1;
export const SENTRY_REPLAY_ON_ERROR_SAMPLE_RATE = import.meta.env
