import {
  ...
  __require,
  __toESM
} from "./main.preset-8j9zm90b.js";

// ../../node_modules/react-router/dist/development/chunk-SZQUWNVJ.js
import * as _react from "react";
var require_chunk_SZQUWNVJ = __commonJS((exports) => {
  ...
  function createRouter(init) {
    ...
    async function navigate(to, opts) {
      ...
      let normalizedPath = normalizeTo(state.location, state.matches, basename, to, _optionalChain([opts, "optionalAccess", (_17) => _17.fromRouteId]), _optionalChain([opts, "optionalAccess", (_18) => _18.relative]));
    ...
    async function startNavigation(historyAction, location, opts) {
      ...
      let matches = _optionalChain([opts, "optionalAccess", (_19) => _19.initialHydration]) && state.matches && state.matches.length > 0 && !initialMatchesIsFOW ? state.matches : matchRoutes(routesToUse, location, basename);
      let flushSync = (opts && opts.flushSync) === true;
      ...
      let {
        ...
        loaderData,
        errors
      } = await handleLoaders(request, location, matches, scopedContext, fogOfWar.active, loadingNavigation, opts && opts.submission, opts && opts.fetcherSubmission, opts && opts.replace, opts && opts.initialHydration === true, flushSync, pendingActionResult, opts && opts.callSiteDefaultShouldRevalidate);
      if (shortCircuited) {
        return;
      }
      pendingNavigationController = null;
    ...
    async function fetch2(key, routeId, href, opts) {
      ...
      let flushSync = (opts && opts.flushSync) === true;
      let routesToUse = inFlightDataRoutes || dataRoutes;
      let normalizedPath = normalizeTo(state.location, state.matches, basename, href, routeId, _optionalChain([opts, "optionalAccess", (_20) => _20.relative]));
    ...
    async function callDataStrategy(request, matches, scopedContext, fetcherKey) {
      ...
      if (!isMutationMethod(request.method)) {
        for (let match of matches) {
          if (_optionalChain([results, "access", (_23) => _23[match.route.id], "optionalAccess", (_24) => _24.type]) === "error") {
            break;
          }
        ...
        try {
          ...
          let response = await runServerMiddlewarePipeline({
            ...
            if (renderedStaticContext) {
              ...
              let boundaryRouteId = skipLoaderErrorBubbling ? routeId : findNearestBoundary(matches, _optionalChain([matches, "access", (_28) => _28.find, "call", (_29) => _29((m) => m.route.id === routeId || m.route.loader), "optionalAccess", (_30) => _30.route, "access", (_31) => _31.id]) || routeId).route.id;
              let staticContext = {
                matches,
                location,
                basename,
...
`, "") : String(opts.body);
  ...
  function patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties2, allowElementMutations) {
    ...
    if (uniqueChildren.length > 0) {
      let newRoutes = convertRoutesToDataRoutes(uniqueChildren, mapRouteProperties2, [routeId || "_", "patch", String(_optionalChain([childrenToPatch, "optionalAccess", (_41) => _41.length]) || "0")], manifest);
  ...
  function isSameRoute(newRoute, existingRoute) {
    ...
    return newRoute.children.every((aChild, i) => _optionalChain([existingRoute, "access", (_42) => _42.children, "optionalAccess", (_43) => _43.some, "call", (_44) => _44((bChild) => isSameRoute(aChild, bChild))]));
  }
  ...
  async function convertDataStrategyResultToDataResult(dataStrategyResult) {
      ...
      if (isDataWithResponseInit(result)) {
        if (result.data instanceof Error) {
          return {
            ...
            headers: _optionalChain([result, "access", (_61) => _61.init, "optionalAccess", (_62) => _62.headers]) ? new Headers(result.init.headers) : undefined
          };
        }
        return {
          type: "error",
          ...
          headers: _optionalChain([result, "access", (_63) => _63.init, "optionalAccess", (_64) => _64.headers]) ? new Headers(result.init.headers) : undefined
        };
      }
      return {
        type: "error",
    ...
    if (isDataWithResponseInit(result)) {
      return {
        ...
        headers: _optionalChain([result, "access", (_67) => _67.init, "optionalAccess", (_68) => _68.headers]) ? new Headers(result.init.headers) : undefined
      };
    }
  ...
  function dataWithResponseInitToResponse(data2) {
    return Response.json(data2.data, _nullishCoalesce(data2.init, () => {
      return;
    }));
  }
  function dataWithResponseInitToErrorResponse(data2) {
    return new ErrorResponseImpl(_nullishCoalesce(_optionalChain([data2, "access", (_71) => _71.init, "optionalAccess", (_72) => _72.status]), () => 500), _nullishCoalesce(_optionalChain([data2, "access", (_73) => _73.init, "optionalAccess", (_74) => _74.statusText]), () => "Internal Server Error"), data2.data);
  }
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
    ...
    if (locationArg) {
      ...
      invariant(parentPathnameBase === "/" || _optionalChain([parsedLocationArg, "access", (_79) => _79.pathname, "optionalAccess", (_80) => _80.startsWith, "call", (_81) => _81(parentPathnameBase)]), `When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${parentPathnameBase}" but pathname "${parsedLocationArg.pathname}" was given in the \`location\` prop.`);
  ...
  var RenderErrorBoundary = class extends React3.Component {
    ...
    render() {
      ...
      let result = error !== undefined ? /* @__PURE__ */ React3.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ React3.createElement(RouteErrorContext.Provider, {
        value: error,
  ...
  function _renderMatches(matches, parentMatches = [], dataRouterState = null, onErrorHandler = null, future = null) {
    ...
    if (errors != null) {
      let errorIndex = renderedMatches.findIndex((m) => m.route.id && _optionalChain([errors, "optionalAccess", (_83) => _83[m.route.id]]) !== undefined);
  ...
  function getKeyedLinksForMatches(matches, routeModules, manifest) {
    let descriptors = matches.map((match) => {
      ...
      return [
        ...
        _optionalChain([module2, "optionalAccess", (_93) => _93.links, "optionalCall", (_94) => _94()]) || []
      ];
    }).flat(2);
  ...
  function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
    ...
    let matchPathChanged = (match, index) => {
      return currentMatches[index].pathname !== match.pathname || _optionalChain([currentMatches, "access", (_95) => _95[index], "access", (_96) => _96.route, "access", (_97) => _97.path, "optionalAccess", (_98) => _98.endsWith, "call", (_99) => _99("*")]) && currentMatches[index].params["*"] !== match.params["*"];
    };
    if (mode === "assets") {
  ...
  function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), needsRevalidation) {
    return (routesByParentId[parentId] || []).map((route) => {
      ...
      if (routeModule) {
        ...
        let initialData = hasInitialData ? _optionalChain([initialState, "optionalAccess", (_102) => _102.loaderData, "optionalAccess", (_103) => _103[route.id]]) : undefined;
        let hasInitialError = initialState && initialState.errors && route.id in initialState.errors;
        let initialError = hasInitialError ? _optionalChain([initialState, "optionalAccess", (_104) => _104.errors, "optionalAccess", (_105) => _105[route.id]]) : undefined;
        ...
        dataRoute.lazy = {
          ...
          middleware: route.hasClientMiddleware ? async () => {
            let { clientMiddleware } = route.clientMiddlewareModule ? await Promise.resolve().then(() => _interopRequireWildcard(__require(route.clientMiddlewareModule))) : await getLazyRoute();
  ...
  function useFogOFWarDiscovery(router, manifest, routeModules, ssr, routeDiscovery, isSpaMode) {
    React6.useEffect(() => {
      if (!isFogOfWarEnabled(routeDiscovery, ssr) || _optionalChain([window, "access", (_108) => _108.navigator, "optionalAccess", (_109) => _109.connection, "optionalAccess", (_110) => _110.saveData]) === true) {
        return;
      }
  ...
  async function fetchAndApplyManifestPatches(paths, errorReloadPath, manifest, routeModules, ssr, isSpaMode, basename, manifestPath, patchRoutes, signal) {
    ...
    try {
      ...
      if (_optionalChain([signal, "optionalAccess", (_111) => _111.aborted]))
        return;
      throw e;
    }
  ...
  function Links({ nonce }) {
    ...
    return /* @__PURE__ */ React7.createElement(React7.Fragment, null, typeof criticalCss === "string" ? /* @__PURE__ */ React7.createElement("style", {
      ...
      nonce
    }) : null, keyedLinks.map(({ key, link }) => isPageLinkDescriptor(link) ? /* @__PURE__ */ React7.createElement(PrefetchPageLinks, { key, nonce, ...link }) : /* @__PURE__ */ React7.createElement("link", { key, nonce, ...link })));
  }
  ...
  function PrefetchPageLinksImpl({
    ...
    return /* @__PURE__ */ React7.createElement(React7.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ React7.createElement("link", { key: href, rel: "prefetch", as: "fetch", href, ...linkProps })), moduleHrefs.map((href) => /* @__PURE__ */ React7.createElement("link", { key: href, rel: "modulepreload", href, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => /* @__PURE__ */ React7.createElement("link", { key, nonce: linkProps.nonce, ...link })));
  }
  function Meta() {
...
// ../../node_modules/react-router/dist/development/chunk-GNDLROV6.js
import * as _react2 from "react";
var require_chunk_GNDLROV6 = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
  }
  var _chunkSZQUWNVJjs = require_chunk_SZQUWNVJ();
  function getHydrationData({
    ...
    let initialMatches = _chunkSZQUWNVJjs.matchRoutes.call(undefined, routes, location, basename);
    if (initialMatches) {
      for (let match of initialMatches) {
        let routeId = match.route.id;
        let routeInfo = getRouteInfo(routeId);
        if (_chunkSZQUWNVJjs.shouldHydrateRouteLoader.call(undefined, routeId, routeInfo.clientLoader, routeInfo.hasLoader, isSpaMode) && (routeInfo.hasHydrateFallback || !routeInfo.hasLoader)) {
  ...
  var _react22 = _interopRequireDefault(_react2);
  var RSCRouterGlobalErrorBoundary = class extends _react22.default.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      if (this.state.error) {
        return /* @__PURE__ */ _react22.default.createElement(RSCDefaultRootErrorBoundaryImpl, {
          error: this.state.error,
          renderAppShell: true
        });
      } else {
  ...
  function ErrorWrapper({
    ...
    return /* @__PURE__ */ _react22.default.createElement("html", { lang: "en" }, /* @__PURE__ */ _react22.default.createElement("head", null, /* @__PURE__ */ _react22.default.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ _react22.default.createElement("meta", {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }), /* @__PURE__ */ _react22.default.createElement("title", null, title)), /* @__PURE__ */ _react22.default.createElement("body", null, /* @__PURE__ */ _react22.default.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children)));
  }
  function RSCDefaultRootErrorBoundaryImpl({
    ...
    console.error(error);
    let heyDeveloper = /* @__PURE__ */ _react22.default.createElement("script", {
      dangerouslySetInnerHTML: {
        __html: `
        console.log(
          "\uD83D\uDCBF Hey developer \uD83D\uDC4B. You can provide a way better UX than this when your app throws errors. Check out https://reactrouter.com/how-to/error-boundary for more information."
    ...
    if (_chunkSZQUWNVJjs.isRouteErrorResponse.call(undefined, error)) {
      return /* @__PURE__ */ _react22.default.createElement(ErrorWrapper, {
        renderAppShell,
        title: "Unhandled Thrown Response!"
      }, /* @__PURE__ */ _react22.default.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), _chunkSZQUWNVJjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null);
    }
    let errorInstance;
    if (error instanceof Error) {
      errorInstance = error;
    ...
    return /* @__PURE__ */ _react22.default.createElement(ErrorWrapper, { renderAppShell, title: "Application Error!" }, /* @__PURE__ */ _react22.default.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), /* @__PURE__ */ _react22.default.createElement("pre", {
      style: {
        padding: "2rem",
        background: "hsla(10, 50%, 50%, 0.1)",
        color: "red",
  ...
  function RSCDefaultRootErrorBoundary({
    ...
    let error = _chunkSZQUWNVJjs.useRouteError.call(undefined);
...
// ../../node_modules/react-router/dist/development/chunk-2JY4UAJA.js
import * as _react3 from "react";
var require_chunk_2JY4UAJA = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  function _interopRequireWildcard(obj) {
    if (obj && obj.__esModule) {
      return obj;
  ...
  function getFormEncType(encType) {
    if (encType != null && !supportedFormEncTypes.has(encType)) {
      _chunkSZQUWNVJjs.warning.call(undefined, false, `"${encType}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${defaultEncType}"`);
      return null;
    }
    return encType;
  }
  function getFormSubmissionInfo(target, basename) {
    ...
    if (isFormElement(target)) {
      ...
      action = attr ? _chunkSZQUWNVJjs.stripBasename.call(undefined, attr, basename) : null;
  ...
  var React = _interopRequireWildcard(_react3);
  var React2 = _interopRequireWildcard(_react3);
  var isBrowser = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined";
  try {
    if (isBrowser) {
  ...
  function createBrowserRouter(routes, opts) {
    return _chunkSZQUWNVJjs.createRouter.call(undefined, {
      ...
      history: _chunkSZQUWNVJjs.createBrowserHistory.call(undefined, { window: _optionalChain([opts, "optionalAccess", (_5) => _5.window]) }),
  ...
  function createHashRouter(routes, opts) {
    return _chunkSZQUWNVJjs.createRouter.call(undefined, {
      ...
      history: _chunkSZQUWNVJjs.createHashHistory.call(undefined, { window: _optionalChain([opts, "optionalAccess", (_14) => _14.window]) }),
  ...
  function deserializeErrors(errors) {
    ...
    for (let [key, val] of entries) {
      if (val && val.__type === "RouteErrorResponse") {
        serialized[key] = new (0, _chunkSZQUWNVJjs.ErrorResponseImpl)(val.status, val.statusText, val.data, val.internal === true);
  ...
  function BrowserRouter({
    ...
    if (historyRef.current == null) {
      historyRef.current = _chunkSZQUWNVJjs.createBrowserHistory.call(undefined, { window: window2, v5Compat: true });
    }
    let history = historyRef.current;
    ...
    return /* @__PURE__ */ React.createElement(_chunkSZQUWNVJjs.Router, {
      basename,
      children,
      location: state.location,
      navigationType: state.action,
  ...
  function HashRouter({
    ...
    let historyRef = React.useRef();
    if (historyRef.current == null) {
      historyRef.current = _chunkSZQUWNVJjs.createHashHistory.call(undefined, { window: window2, v5Compat: true });
    }
    let history = historyRef.current;
    let [state, setStateImpl] = React.useState({
      action: history.action,
  ...
  var Link = React.forwardRef(function LinkWithRef({
    ...
    let parsed = _chunkSZQUWNVJjs.parseToInfo.call(undefined, to, basename);
    to = parsed.to;
    let href = _chunkSZQUWNVJjs.useHref.call(undefined, to, { relative });
    let [shouldPrefetch, prefetchRef, prefetchHandlers] = _chunkSZQUWNVJjs.usePrefetchBehavior.call(undefined, prefetch, rest);
    ...
    let link = /* @__PURE__ */ React.createElement("a", {
      ...
      ref: _chunkSZQUWNVJjs.mergeRefs.call(undefined, forwardedRef, prefetchRef),
      target,
  ...
  var NavLink = React.forwardRef(function NavLinkWithRef({
    ...
    let path = _chunkSZQUWNVJjs.useResolvedPath.call(undefined, to, { relative: rest.relative });
    let location = _chunkSZQUWNVJjs.useLocation.call(undefined);
    ...
    if (nextLocationPathname && basename) {
      nextLocationPathname = _chunkSZQUWNVJjs.stripBasename.call(undefined, nextLocationPathname, basename) || nextLocationPathname;
    }
  ...
  function ScrollRestoration({
    ...
    let location = _chunkSZQUWNVJjs.useLocation.call(undefined);
    let matches = _chunkSZQUWNVJjs.useMatches.call(undefined);
  ...
  function useDataRouterContext(hookName) {
    ...
    _chunkSZQUWNVJjs.invariant.call(undefined, ctx, getDataRouterConsoleError(hookName));
    return ctx;
  }
  function useDataRouterState(hookName) {
    let state = React.useContext(_chunkSZQUWNVJjs.DataRouterStateContext);
    _chunkSZQUWNVJjs.invariant.call(undefined, state, getDataRouterConsoleError(hookName));
    return state;
  }
  function useLinkClickHandler(to, {
    ...
    let navigate = _chunkSZQUWNVJjs.useNavigate.call(undefined);
    let location = _chunkSZQUWNVJjs.useLocation.call(undefined);
    let path = _chunkSZQUWNVJjs.useResolvedPath.call(undefined, to, { relative });
    return React.useCallback((event) => {
      if (shouldProcessLinkClick(event, target)) {
        event.preventDefault();
        let replace = replaceProp !== undefined ? replaceProp : _chunkSZQUWNVJjs.createPath.call(undefined, location) === _chunkSZQUWNVJjs.createPath.call(undefined, path);
  ...
  function useSearchParams(defaultInit) {
    _chunkSZQUWNVJjs.warning.call(undefined, typeof URLSearchParams !== "undefined", `You cannot use the \`useSearchParams\` hook in a browser that does not support the URLSearchParams API. If you need to support Internet Explorer 11, we recommend you load a polyfill such as https://github.com/ungap/url-search-params.`);
  ...
  function useSubmit() {
    ...
    let { basename } = React.useContext(_chunkSZQUWNVJjs.NavigationContext);
    let currentRouteId = _chunkSZQUWNVJjs.useRouteId.call(undefined);
  ...
  function useFormAction(action, { relative } = {}) {
    ...
    _chunkSZQUWNVJjs.invariant.call(undefined, routeContext, "useFormAction must be used inside a RouteContext");
    let [match] = routeContext.matches.slice(-1);
    let path = { ..._chunkSZQUWNVJjs.useResolvedPath.call(undefined, action ? action : ".", { relative }) };
    let location = _chunkSZQUWNVJjs.useLocation.call(undefined);
    if (action == null) {
      path.search = location.search;
      let params = new URLSearchParams(path.search);
    ...
    if (basename !== "/") {
      path.pathname = path.pathname === "/" ? basename : _chunkSZQUWNVJjs.joinPaths.call(undefined, [basename, path.pathname]);
    }
    return _chunkSZQUWNVJjs.createPath.call(undefined, path);
  }
  function useFetcher({
    key
  } = {}) {
    ...
    _chunkSZQUWNVJjs.invariant.call(undefined, fetcherData, `useFetcher must be used inside a FetchersContext`);
    _chunkSZQUWNVJjs.invariant.call(undefined, route, `useFetcher must be used inside a RouteContext`);
    _chunkSZQUWNVJjs.invariant.call(undefined, routeId != null, `useFetcher can only be used on routes that contain a unique "id"`);
    ...
    let load = React.useCallback(async (href, opts) => {
      _chunkSZQUWNVJjs.invariant.call(undefined, routeId, "No routeId available for fetcher.load()");
  ...
  function getScrollRestorationKey(location, matches, basename, getKey) {
    ...
    if (getKey) {
      if (basename !== "/") {
        key = getKey({
          ...location,
          pathname: _chunkSZQUWNVJjs.stripBasename.call(undefined, location.pathname, basename) || location.pathname
        }, matches);
      } else {
  ...
  function useScrollRestoration({
    ...
    let location = _chunkSZQUWNVJjs.useLocation.call(undefined);
    let matches = _chunkSZQUWNVJjs.useMatches.call(undefined);
    let navigation = _chunkSZQUWNVJjs.useNavigation.call(undefined);
    React.useEffect(() => {
    ...
    usePageHide(React.useCallback(() => {
      ...
      try {
        ...
        _chunkSZQUWNVJjs.warning.call(undefined, false, `Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (${error}).`);
      }
      window.history.scrollRestoration = "auto";
    ...
    if (typeof document !== "undefined") {
      ...
      React.useLayoutEffect(() => {
        let disableScrollRestoration = _optionalChain([router, "optionalAccess", (_27) => _27.enableScrollRestoration, "call", (_28) => _28(savedScrollPositions, () => window.scrollY, getKey ? (location2, matches2) => getScrollRestorationKey(location2, matches2, basename, getKey) : undefined)]);
      ...
      React.useLayoutEffect(() => {
        ...
        try {
          ...
          _chunkSZQUWNVJjs.warning.call(undefined, false, `"${location.hash.slice(1)}" is not a decodable element ID. The view will not scroll to it.`);
        }
  ...
  function usePrompt({
    ...
    let blocker = _chunkSZQUWNVJjs.useBlocker.call(undefined, when);
    React.useEffect(() => {
  ...
  function useViewTransitionState(to, { relative } = {}) {
    ...
    _chunkSZQUWNVJjs.invariant.call(undefined, vtContext != null, "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");
    let { basename } = useDataRouterContext("useViewTransitionState");
    let path = _chunkSZQUWNVJjs.useResolvedPath.call(undefined, to, { relative });
    if (!vtContext.isTransitioning) {
      return false;
    }
    let currentPath = _chunkSZQUWNVJjs.stripBasename.call(undefined, vtContext.currentLocation.pathname, basename) || vtContext.currentLocation.pathname;
    let nextPath = _chunkSZQUWNVJjs.stripBasename.call(undefined, vtContext.nextLocation.pathname, basename) || vtContext.nextLocation.pathname;
    return _chunkSZQUWNVJjs.matchPath.call(undefined, path.pathname, nextPath) != null || _chunkSZQUWNVJjs.matchPath.call(undefined, path.pathname, currentPath) != null;
  }
  function StaticRouter({
    ...
    if (typeof locationProp === "string") {
      locationProp = _chunkSZQUWNVJjs.parsePath.call(undefined, locationProp);
    }
    let action = "POP";
    let location = {
    ...
    return /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.Router, {
      basename,
      children,
      location,
  ...
  function StaticRouterProvider({
    ...
    _chunkSZQUWNVJjs.invariant.call(undefined, router && context, "You must provide `router` and `context` to <StaticRouterProvider>");
    ...
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.FetchersContext.Provider, { value: fetchersContext }, /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.ViewTransitionContext.Provider, { value: { isTransitioning: false } }, /* @__PURE__ */ React2.createElement(_chunkSZQUWNVJjs.Router, {
  ...
  function DataRoutes({
    ...
    return _chunkSZQUWNVJjs.useRoutesImpl.call(undefined, routes, undefined, state, undefined, future);
  }
  function serializeErrors(errors) {
    ...
    let serialized = {};
    for (let [key, val] of entries) {
      if (_chunkSZQUWNVJjs.isRouteErrorResponse.call(undefined, val)) {
  ...
  function createStaticHandler2(routes, opts) {
    return _chunkSZQUWNVJjs.createStaticHandler.call(undefined, routes, {
      ...opts,
      mapRouteProperties: _chunkSZQUWNVJjs.mapRouteProperties
    });
  }
  function createStaticRouter(routes, context, opts = {}) {
    let manifest = {};
    let dataRoutes = _chunkSZQUWNVJjs.convertRoutesToDataRoutes.call(undefined, routes, _chunkSZQUWNVJjs.mapRouteProperties, undefined, manifest);
  ...
  function createHref(to) {
    return typeof to === "string" ? to : _chunkSZQUWNVJjs.createPath.call(undefined, to);
  }
  function encodeLocation(to) {
    let href = typeof to === "string" ? to : _chunkSZQUWNVJjs.createPath.call(undefined, to);
    href = href.replace(/ $/, "%20");
...
var require_development = __commonJS((exports) => {
  ...
  var _chunkGNDLROV6js = require_chunk_GNDLROV6();
  var _chunk2JY4UAJAjs = require_chunk_2JY4UAJA();
  var _chunkSZQUWNVJjs = require_chunk_SZQUWNVJ();
  var React = _interopRequireWildcard(_react4);
  var React2 = _interopRequireWildcard(_react4);
  var React3 = _interopRequireWildcard(_react4);
  function ServerRouter({
    ...
    let routes = _chunkSZQUWNVJjs.createServerRoutes.call(undefined, manifest.routes, routeModules, context.future, context.isSpaMode);
    ...
    for (let match of context.staticHandlerContext.matches) {
      ...
      if (route && manifestRoute && _chunkSZQUWNVJjs.shouldHydrateRouteLoader.call(undefined, routeId, route.clientLoader, manifestRoute.hasLoader, context.isSpaMode) && (route.HydrateFallback || !manifestRoute.hasLoader)) {
        delete context.staticHandlerContext.loaderData[routeId];
      }
    }
    let router = _chunk2JY4UAJAjs.createStaticRouter.call(undefined, routes, context.staticHandlerContext);
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(_chunkSZQUWNVJjs.FrameworkContext.Provider, {
      value: {
        manifest,
        routeModules,
        criticalCss,
    ...
    }, /* @__PURE__ */ React.createElement(_chunkSZQUWNVJjs.RemixErrorBoundary, { location: router.state.location }, /* @__PURE__ */ React.createElement(_chunk2JY4UAJAjs.StaticRouterProvider, {
      router,
      context: context.staticHandlerContext,
      hydrate: false
    }))), context.serverHandoffStream ? /* @__PURE__ */ React.createElement(React.Suspense, null, /* @__PURE__ */ React.createElement(_chunkSZQUWNVJjs.StreamTransfer, {
      context,
      identifier: 0,
  ...
  function createRoutesStub(routes, _context) {
    return function RoutesTestStub({
      ...
      if (routerRef.current == null) {
        ...
        let patched = processRoutes(_chunkSZQUWNVJjs.convertRoutesToDataRoutes.call(undefined, routes, (r) => r), _context !== undefined ? _context : _optionalChain([future, "optionalAccess", (_4) => _4.v8_middleware]) ? new (0, _chunkSZQUWNVJjs.RouterContextProvider) : {}, frameworkContextRef.current.manifest, frameworkContextRef.current.routeModules);
        routerRef.current = _chunkSZQUWNVJjs.createMemoryRouter.call(undefined, patched, {
          initialEntries,
          initialIndex,
          hydrationData
        });
  ...
  function processRoutes(routes, context, manifest, routeModules, parentId) {
    return routes.map((route) => {
      ...
      let newRoute = {
        ...
        path: route.path,
        index: route.index,
        Component: route.Component ? _chunkSZQUWNVJjs.withComponentProps.call(undefined, route.Component) : undefined,
        HydrateFallback: route.HydrateFallback ? _chunkSZQUWNVJjs.withHydrateFallbackProps.call(undefined, route.HydrateFallback) : undefined,
        ErrorBoundary: route.ErrorBoundary ? _chunkSZQUWNVJjs.withErrorBoundaryProps.call(undefined, route.ErrorBoundary) : undefined,
  ...
  function warnOnceAboutExpiresCookie(name, expires) {
    _chunkSZQUWNVJjs.warnOnce.call(undefined, !expires, `The "${name}" cookie has an "expires" property set. This will cause the expires value to not be updated when the session is committed. Instead, you should set the expires value when serializing the cookie. You can use \`commitSession(session, { expires })\` if using a session storage object, or \`cookie.serialize("value", { expires })\` if you're using the cookie directly.`);
  }
  ...
  function matchServerRoutes(routes, pathname, basename) {
    let matches = _chunkSZQUWNVJjs.matchRoutes.call(undefined, routes, pathname, basename);
    if (!matches)
      return null;
    return matches.map((match) => ({
      params: match.params,
  ...
  async function callRouteHandler(handler, args) {
    ...
    if (_chunkSZQUWNVJjs.isDataWithResponseInit.call(undefined, result) && result.init && result.init.status && _chunkSZQUWNVJjs.isRedirectStatusCode.call(undefined, result.init.status)) {
      ...
      let commonRoute = {
        ...
        loader: route.module.loader ? async (args) => {
          ...
          if (preRenderedData != null) {
            ...
            let decoded = await _chunkSZQUWNVJjs.decodeViaTurboStream.call(undefined, stream, global);
            ...
            if (data2 && _chunkSZQUWNVJjs.SingleFetchRedirectSymbol in data2) {
              ...
              if (result.reload) {
                throw _chunkSZQUWNVJjs.redirectDocument.call(undefined, result.redirect, init);
              } else if (result.replace) {
                throw _chunkSZQUWNVJjs.replace.call(undefined, result.redirect, init);
              } else {
                throw _chunkSZQUWNVJjs.redirect.call(undefined, result.redirect, init);
              }
            } else {
  ...
  function createServerHandoffString(serverHandoff) {
    return _chunkSZQUWNVJjs.escapeHtml.call(undefined, JSON.stringify(serverHandoff));
  }
  ...
  async function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
    ...
    function handleQueryResult(result) {
      return _chunkSZQUWNVJjs.isResponse.call(undefined, result) ? result : staticContextToResponse(result);
    }
    ...
    function staticContextToResponse(context) {
      ...
      if (_chunkSZQUWNVJjs.isRedirectStatusCode.call(undefined, context.statusCode) && headers.has("Location")) {
        return new Response(null, { status: context.statusCode, headers });
      }
      if (context.errors) {
        Object.values(context.errors).forEach((err) => {
          if (!_chunkSZQUWNVJjs.isRouteErrorResponse.call(undefined, err) || err.error) {
            handleError(err);
          }
        });
  ...
  function getSingleFetchRedirect(status, headers, basename) {
    ...
    if (basename) {
      redirect2 = _chunkSZQUWNVJjs.stripBasename.call(undefined, redirect2, basename) || redirect2;
    }
    return {
      redirect: redirect2,
      status,
  ...
  function encodeViaTurboStream(data2, requestSignal, streamTimeout, serverMode) {
    ...
    return _chunkSZQUWNVJjs.encode.call(undefined, data2, {
  ...
  function derive(build, mode) {
    ...
    let staticHandler = _chunkSZQUWNVJjs.createStaticHandler.call(undefined, dataRoutes, {
    ...
    let errorHandler = build.entry.module.handleError || ((error, { request }) => {
      if (serverMode !== "test" && !request.signal.aborted) {
        console.error(_chunkSZQUWNVJjs.isRouteErrorResponse.call(undefined, error) && error.error ? error.error : error);
      }
    });
    let requestHandler = async (request, initialContext) => {
      ...
      if (_chunkSZQUWNVJjs.stripBasename.call(undefined, normalizedPath, normalizedBasename) === "/_root.data") {
        normalizedPath = normalizedBasename;
      } else if (normalizedPath.endsWith(".data")) {
        normalizedPath = normalizedPath.replace(/\.data$/, "");
      }
      if (_chunkSZQUWNVJjs.stripBasename.call(undefined, normalizedPath, normalizedBasename) !== "/" && normalizedPath.endsWith("/")) {
      ...
      if (!build.ssr) {
        ...
        if (normalizedBasename !== "/") {
          let strippedPath = _chunkSZQUWNVJjs.stripBasename.call(undefined, decodedPath, normalizedBasename);
          if (strippedPath == null) {
            errorHandler(new (0, _chunkSZQUWNVJjs.ErrorResponseImpl)(404, "Not Found", `Refusing to prerender the \`${decodedPath}\` path because it does not start with the basename \`${normalizedBasename}\``), {
              context: loadContext,
              params,
              request
            });
        ...
        if (build.prerender.length === 0) {
          ...
          if (url.pathname.endsWith(".data")) {
            errorHandler(new (0, _chunkSZQUWNVJjs.ErrorResponseImpl)(404, "Not Found", `Refusing to SSR the path \`${decodedPath}\` because \`ssr:false\` is set and the path is not included in the \`prerender\` config, so in production the path will be a 404.`), {
              context: loadContext,
              params,
              request
            });
      ...
      let manifestUrl = _chunkSZQUWNVJjs.getManifestPath.call(undefined, build.routeDiscovery.manifestPath, normalizedBasename);
      ...
      if (url.pathname.endsWith(".data")) {
        ...
        if (_chunkSZQUWNVJjs.isRedirectResponse.call(undefined, response)) {
    ...
    if (build.entry.module.unstable_instrumentations) {
      requestHandler = _chunkSZQUWNVJjs.instrumentHandler.call(undefined, requestHandler, build.entry.module.unstable_instrumentations.map((i) => i.handler).filter(Boolean));
    }
    return {
      routes,
      dataRoutes,
  ...
  async function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
    try {
      let result = await staticHandler.query(request, {
        ...
        generateMiddlewareResponse: build.future.v8_middleware ? async (query) => {
          try {
            ...
            if (!_chunkSZQUWNVJjs.isResponse.call(undefined, innerResult)) {
      ...
      if (!_chunkSZQUWNVJjs.isResponse.call(undefined, result)) {
    ...
    async function renderHtml(context, isSpaMode2) {
      ...
      try {
        ...
        if (_chunkSZQUWNVJjs.isResponse.call(undefined, error)) {
          try {
            let data2 = await unwrapResponse(error);
            errorForSecondRender = new (0, _chunkSZQUWNVJjs.ErrorResponseImpl)(error.status, error.statusText, data2);
          } catch (e) {
          }
        }
        context = _chunkSZQUWNVJjs.getStaticContextFromError.call(undefined, staticHandler.dataRoutes, context, errorForSecondRender);
        if (context.errors) {
          context.errors = sanitizeErrors(context.errors, serverMode);
        }
        let state2 = {
...
${String(error)}`;
  ...
  async function routeRSCServerRequest({
    ...
    try {
      ...
      let html = await renderHTML(getPayload, {
        onError(error) {
          if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
            renderRedirect = _chunkSZQUWNVJjs.decodeRedirectErrorDigest.call(undefined, error.digest);
            if (renderRedirect) {
              return error.digest;
            }
            let routeErrorResponse = _chunkSZQUWNVJjs.decodeRouteErrorResponseDigest.call(undefined, error.digest);
      ...
      const redirectTransform = new TransformStream({
        flush(controller) {
          if (renderRedirect) {
            controller.enqueue(new TextEncoder().encode(`<meta http-equiv="refresh" content="0;url=${_chunkSZQUWNVJjs.escapeHtml.call(undefined, renderRedirect.location)}"/>`));
          }
        }
      });
      if (!hydrate) {
      ...
      try {
        ...
        let [status, statusText] = _chunkSZQUWNVJjs.isRouteErrorResponse.call(undefined, reason) ? [reason.status, reason.statusText] : [500, ""];
        let retryRedirect;
        let reactHeaders = new Headers;
        const html = await renderHTML(() => {
          ...
          onError(error) {
            if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
              retryRedirect = _chunkSZQUWNVJjs.decodeRedirectErrorDigest.call(undefined, error.digest);
              if (retryRedirect) {
                return error.digest;
              }
              let routeErrorResponse = _chunkSZQUWNVJjs.decodeRouteErrorResponseDigest.call(undefined, error.digest);
        ...
        const retryRedirectTransform = new TransformStream({
          flush(controller) {
            if (retryRedirect) {
              controller.enqueue(new TextEncoder().encode(`<meta http-equiv="refresh" content="0;url=${_chunkSZQUWNVJjs.escapeHtml.call(undefined, retryRedirect.location)}"/>`));
            }
          }
        });
        if (!hydrate) {
  ...
  function RSCStaticRouter({ getPayload }) {
    ...
    for (const match of payload.matches) {
      if (_chunkSZQUWNVJjs.shouldHydrateRouteLoader.call(undefined, match.id, match.clientLoader, match.hasLoader, false) && (match.hydrateFallbackElement || !match.hasLoader)) {
    ...
    const router = _chunk2JY4UAJAjs.createStaticRouter.call(undefined, payload.matches.reduceRight((previous, match) => {
      const route = {
        id: match.id,
        action: match.hasAction || !!match.clientAction,
  ...
  exports.Await = _chunkSZQUWNVJjs.Await;
  exports.BrowserRouter = _chunk2JY4UAJAjs.BrowserRouter;
  exports.Form = _chunk2JY4UAJAjs.Form;
  exports.HashRouter = _chunk2JY4UAJAjs.HashRouter;
  exports.IDLE_BLOCKER = _chunkSZQUWNVJjs.IDLE_BLOCKER;
  exports.IDLE_FETCHER = _chunkSZQUWNVJjs.IDLE_FETCHER;
  exports.IDLE_NAVIGATION = _chunkSZQUWNVJjs.IDLE_NAVIGATION;
  exports.Link = _chunk2JY4UAJAjs.Link;
  exports.Links = _chunkSZQUWNVJjs.Links;
  exports.MemoryRouter = _chunkSZQUWNVJjs.MemoryRouter;
  exports.Meta = _chunkSZQUWNVJjs.Meta;
  exports.NavLink = _chunk2JY4UAJAjs.NavLink;
  exports.Navigate = _chunkSZQUWNVJjs.Navigate;
  exports.NavigationType = _chunkSZQUWNVJjs.Action;
  exports.Outlet = _chunkSZQUWNVJjs.Outlet;
  exports.PrefetchPageLinks = _chunkSZQUWNVJjs.PrefetchPageLinks;
  exports.Route = _chunkSZQUWNVJjs.Route;
  exports.Router = _chunkSZQUWNVJjs.Router;
  exports.RouterContextProvider = _chunkSZQUWNVJjs.RouterContextProvider;
  exports.RouterProvider = _chunkSZQUWNVJjs.RouterProvider;
  exports.Routes = _chunkSZQUWNVJjs.Routes;
  exports.Scripts = _chunkSZQUWNVJjs.Scripts;
  exports.ScrollRestoration = _chunk2JY4UAJAjs.ScrollRestoration;
  exports.ServerRouter = ServerRouter;
  exports.StaticRouter = _chunk2JY4UAJAjs.StaticRouter;
  exports.StaticRouterProvider = _chunk2JY4UAJAjs.StaticRouterProvider;
  exports.UNSAFE_AwaitContextProvider = _chunkSZQUWNVJjs.AwaitContextProvider;
  exports.UNSAFE_DataRouterContext = _chunkSZQUWNVJjs.DataRouterContext;
  exports.UNSAFE_DataRouterStateContext = _chunkSZQUWNVJjs.DataRouterStateContext;
  exports.UNSAFE_ErrorResponseImpl = _chunkSZQUWNVJjs.ErrorResponseImpl;
  exports.UNSAFE_FetchersContext = _chunkSZQUWNVJjs.FetchersContext;
  exports.UNSAFE_FrameworkContext = _chunkSZQUWNVJjs.FrameworkContext;
  exports.UNSAFE_LocationContext = _chunkSZQUWNVJjs.LocationContext;
  exports.UNSAFE_NavigationContext = _chunkSZQUWNVJjs.NavigationContext;
  exports.UNSAFE_RSCDefaultRootErrorBoundary = _chunkGNDLROV6js.RSCDefaultRootErrorBoundary;
  exports.UNSAFE_RemixErrorBoundary = _chunkSZQUWNVJjs.RemixErrorBoundary;
  exports.UNSAFE_RouteContext = _chunkSZQUWNVJjs.RouteContext;
  exports.UNSAFE_ServerMode = ServerMode;
  exports.UNSAFE_SingleFetchRedirectSymbol = _chunkSZQUWNVJjs.SingleFetchRedirectSymbol;
  exports.UNSAFE_ViewTransitionContext = _chunkSZQUWNVJjs.ViewTransitionContext;
  exports.UNSAFE_WithComponentProps = _chunkSZQUWNVJjs.WithComponentProps;
  exports.UNSAFE_WithErrorBoundaryProps = _chunkSZQUWNVJjs.WithErrorBoundaryProps;
  exports.UNSAFE_WithHydrateFallbackProps = _chunkSZQUWNVJjs.WithHydrateFallbackProps;
  exports.UNSAFE_createBrowserHistory = _chunkSZQUWNVJjs.createBrowserHistory;
  exports.UNSAFE_createClientRoutes = _chunkSZQUWNVJjs.createClientRoutes;
  exports.UNSAFE_createClientRoutesWithHMRRevalidationOptOut = _chunkSZQUWNVJjs.createClientRoutesWithHMRRevalidationOptOut;
  exports.UNSAFE_createRouter = _chunkSZQUWNVJjs.createRouter;
  exports.UNSAFE_decodeViaTurboStream = _chunkSZQUWNVJjs.decodeViaTurboStream;
  exports.UNSAFE_deserializeErrors = deserializeErrors;
  exports.UNSAFE_getHydrationData = _chunkGNDLROV6js.getHydrationData;
  exports.UNSAFE_getPatchRoutesOnNavigationFunction = _chunkSZQUWNVJjs.getPatchRoutesOnNavigationFunction;
  exports.UNSAFE_getTurboStreamSingleFetchDataStrategy = _chunkSZQUWNVJjs.getTurboStreamSingleFetchDataStrategy;
  exports.UNSAFE_hydrationRouteProperties = _chunkSZQUWNVJjs.hydrationRouteProperties;
  exports.UNSAFE_invariant = _chunkSZQUWNVJjs.invariant;
  exports.UNSAFE_mapRouteProperties = _chunkSZQUWNVJjs.mapRouteProperties;
  exports.UNSAFE_shouldHydrateRouteLoader = _chunkSZQUWNVJjs.shouldHydrateRouteLoader;
  exports.UNSAFE_useFogOFWarDiscovery = _chunkSZQUWNVJjs.useFogOFWarDiscovery;
  exports.UNSAFE_useScrollRestoration = _chunk2JY4UAJAjs.useScrollRestoration;
  exports.UNSAFE_withComponentProps = _chunkSZQUWNVJjs.withComponentProps;
  exports.UNSAFE_withErrorBoundaryProps = _chunkSZQUWNVJjs.withErrorBoundaryProps;
  exports.UNSAFE_withHydrateFallbackProps = _chunkSZQUWNVJjs.withHydrateFallbackProps;
  exports.createBrowserRouter = _chunk2JY4UAJAjs.createBrowserRouter;
  exports.createContext = _chunkSZQUWNVJjs.createContext;
  exports.createCookie = createCookie;
  exports.createCookieSessionStorage = createCookieSessionStorage;
  exports.createHashRouter = _chunk2JY4UAJAjs.createHashRouter;
  exports.createMemoryRouter = _chunkSZQUWNVJjs.createMemoryRouter;
  exports.createMemorySessionStorage = createMemorySessionStorage;
  exports.createPath = _chunkSZQUWNVJjs.createPath;
  exports.createRequestHandler = createRequestHandler;
  exports.createRoutesFromChildren = _chunkSZQUWNVJjs.createRoutesFromChildren;
  exports.createRoutesFromElements = _chunkSZQUWNVJjs.createRoutesFromElements;
  exports.createRoutesStub = createRoutesStub;
  exports.createSearchParams = _chunk2JY4UAJAjs.createSearchParams;
  exports.createSession = createSession;
  exports.createSessionStorage = createSessionStorage;
  exports.createStaticHandler = _chunk2JY4UAJAjs.createStaticHandler;
  exports.createStaticRouter = _chunk2JY4UAJAjs.createStaticRouter;
  exports.data = _chunkSZQUWNVJjs.data;
  exports.generatePath = _chunkSZQUWNVJjs.generatePath;
  exports.href = href;
  exports.isCookie = isCookie;
  exports.isRouteErrorResponse = _chunkSZQUWNVJjs.isRouteErrorResponse;
  exports.isSession = isSession;
  exports.matchPath = _chunkSZQUWNVJjs.matchPath;
  exports.matchRoutes = _chunkSZQUWNVJjs.matchRoutes;
  exports.parsePath = _chunkSZQUWNVJjs.parsePath;
  exports.redirect = _chunkSZQUWNVJjs.redirect;
  exports.redirectDocument = _chunkSZQUWNVJjs.redirectDocument;
  exports.renderMatches = _chunkSZQUWNVJjs.renderMatches;
  exports.replace = _chunkSZQUWNVJjs.replace;
  exports.resolvePath = _chunkSZQUWNVJjs.resolvePath;
  exports.unstable_HistoryRouter = _chunk2JY4UAJAjs.HistoryRouter;
  ...
  exports.unstable_usePrompt = _chunk2JY4UAJAjs.usePrompt;
  exports.unstable_useRoute = _chunkSZQUWNVJjs.useRoute;
  exports.useActionData = _chunkSZQUWNVJjs.useActionData;
  exports.useAsyncError = _chunkSZQUWNVJjs.useAsyncError;
  exports.useAsyncValue = _chunkSZQUWNVJjs.useAsyncValue;
  exports.useBeforeUnload = _chunk2JY4UAJAjs.useBeforeUnload;
  exports.useBlocker = _chunkSZQUWNVJjs.useBlocker;
  exports.useFetcher = _chunk2JY4UAJAjs.useFetcher;
  exports.useFetchers = _chunk2JY4UAJAjs.useFetchers;
  exports.useFormAction = _chunk2JY4UAJAjs.useFormAction;
  exports.useHref = _chunkSZQUWNVJjs.useHref;
  exports.useInRouterContext = _chunkSZQUWNVJjs.useInRouterContext;
  exports.useLinkClickHandler = _chunk2JY4UAJAjs.useLinkClickHandler;
  exports.useLoaderData = _chunkSZQUWNVJjs.useLoaderData;
  exports.useLocation = _chunkSZQUWNVJjs.useLocation;
  exports.useMatch = _chunkSZQUWNVJjs.useMatch;
  exports.useMatches = _chunkSZQUWNVJjs.useMatches;
  exports.useNavigate = _chunkSZQUWNVJjs.useNavigate;
  exports.useNavigation = _chunkSZQUWNVJjs.useNavigation;
  exports.useNavigationType = _chunkSZQUWNVJjs.useNavigationType;
  exports.useOutlet = _chunkSZQUWNVJjs.useOutlet;
  exports.useOutletContext = _chunkSZQUWNVJjs.useOutletContext;
  exports.useParams = _chunkSZQUWNVJjs.useParams;
  exports.useResolvedPath = _chunkSZQUWNVJjs.useResolvedPath;
  exports.useRevalidator = _chunkSZQUWNVJjs.useRevalidator;
  exports.useRouteError = _chunkSZQUWNVJjs.useRouteError;
  exports.useRouteLoaderData = _chunkSZQUWNVJjs.useRouteLoaderData;
  exports.useRoutes = _chunkSZQUWNVJjs.useRoutes;
  exports.useSearchParams = _chunk2JY4UAJAjs.useSearchParams;
  exports.useSubmit = _chunk2JY4UAJAjs.useSubmit;
  exports.useViewTransitionState = _chunk2JY4UAJAjs.useViewTransitionState;
});

// src/preview.preset.tsx
var import_react_router = __toESM(require_development(), 1);
import { jsxDEV } from "react/jsx-dev-runtime";
function createStorybookPreviewPreset(options = {}) {
  ...
  const preview = {
    ...
    decorators: [
      (Story) => /* @__PURE__ */ jsxDEV(import_react_router.MemoryRouter, {
        children: /* @__PURE__ */ jsxDEV(Story, {}, undefined, false, undefined, this)
