...
// ../../node_modules/@changesets/get-github-info/dist/get-github-info.cjs.dev.js
var require_get_github_info_cjs_dev = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  var fetch = require_lib3();
  var DataLoader = require_dataloader();
...
`)}
  ...
  var GHDataLoader = new DataLoader__default["default"](async (requests) => {
    ...
    requests.forEach((_ref) => {
      let {
        repo
      } = _ref, data2 = _objectWithoutProperties(_ref, ["repo"]);
...
${JSON.stringify(data)}`);
    ...
    return requests.map((_ref2) => {
      let {
        repo
      } = _ref2, data2 = _objectWithoutProperties(_ref2, ["repo"]);
...
// ../../node_modules/@changesets/get-github-info/dist/get-github-info.cjs.js
var require_get_github_info_cjs = __commonJS((exports, module) => {
  if (false) {
  } else {
    module.exports = require_get_github_info_cjs_dev();
  }
});

// src/index.ts
var import_get_github_info = __toESM(require_get_github_info_cjs(), 1);
...
`).map((l) => l.trimEnd());
    ...
    let user;
    try {
      const info = await import_get_github_info.getInfo({
        repo: options.repo,
      ...
      console.warn(`Failed to fetch GitHub info for commit ${commitToFetch}:`, error instanceof Error ? error.message : String(error));
    }
    let prInfo = null;
    if (prFromSummary !== undefined) {
      try {
        prInfo = await import_get_github_info.getInfoFromPullRequest({
          repo: options.repo,
          pull: prFromSummary
        });
      } catch (error) {
        console.warn(`Failed to fetch GitHub info for PR #${prFromSummary}:`, error instanceof Error ? error.message : String(error));
      }
    }
